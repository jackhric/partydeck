...
export default function PartydeckLogo() {
  return (
    <svg className="w-[min(30%,220px)] animate-logo-in" viewBox="0 0 48.947636 39.299686">
      <defs>
        {/* Coords are in pre-translate user space: the paths live at
            x ∈ [24.70, 73.65], not [0, 48.95], because of the <g> translate. */}
        <linearGradient
          id="pd-rainbow"
        ...
        >
          ...
          <stop offset="0.1667" stopColor="#ffb45c" />
          <stop offset="0.3333" stopColor="#f5e75c" />
          <stop offset="0.5" stopColor="#5ce07c" />
          <stop offset="0.6667" stopColor="#5cc0ff" />
          <stop offset="0.8333" stopColor="#b47cff" />
      ...
      <g transform="translate(-24.70456,-86.867724)">
        ...
        <path fill="url(#pd-rainbow)" d={TOP_LEFT} />
      </g>
    </svg>
  );
}
